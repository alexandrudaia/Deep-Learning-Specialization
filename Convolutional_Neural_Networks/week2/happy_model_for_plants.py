...
happyModel = HappyModel(((128,128,3)))
...
happyModel.fit(x=X_train, y=y_train, epochs=20, batch_size=35)
happyModel.evaluate(X_test,y_test)
########################################
test_path='/home/cruntlyhorses/restnet_test/test'
counter=0
...
submit=pd.read_csv('/home/cruntlyhorses/restnet_test/sample_submission.csv')
